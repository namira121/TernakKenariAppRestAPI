import 'package:canary_project/core/components/buttons.dart';
import 'package:canary_project/core/components/custom_text_field.dart';
import 'package:canary_project/core/components/spaces.dart';
import 'package:canary_project/core/constants/colors.dart';
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Form(
          key: _key,
          child: Padding(
            padding: const EdgeInsets.fromLTRB(16.0, 170.0, 16.0, 0),
            child: Column(
                      ...
                      onPressed: state is LoginLoading
                          ...
                          : () {
                              if (_key.currentState!.validate()) {
                                final request = LoginModelRequest(
                                  email: emailController.text,
                                  password: passwordController.text,
                                );
                                context
                                    .read<LoginBloc>()
                                    .add(LoginRequested(requestModel: request));
                              }
                            },
