...
class AnakRequestModel {
    ...
    factory AnakRequestModel.fromRawJson(String str) => AnakRequestModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory AnakRequestModel.fromJson(Map<String, dynamic> json) => AnakRequestModel(
        noRing: json["no_ring"],
